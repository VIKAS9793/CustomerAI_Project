...
async def analyze_fairness(request_data: Dict):
    ...
    try:
        ...
        mitigation_recommendations = fairness_mitigation.get_mitigation_recommendations(
            fairness_report
        )
...
async def upload_and_analyze(
    ...
    try:
        ...
        # Analyze fairness
        results = bias_detector.detect_outcome_bias(
            df, attributes=attr_list, outcome_columns=outcome_list
        )
    ...
    try:
        ...
        if strategy == "reweigh_samples":
            ...
            transformed_df = fairness_mitigation.disparate_impact_remover(
                df, protected_attribute=attribute, features=features, **strategy_params
            )
        ...
        logger.error(f"Error validating bias threshold: {str(e)}")
    ...
    try:
        ...
        if strategy == "equalized_odds_postprocessing":
            ...
            adjusted_predictions = fairness_mitigation.equalized_odds_postprocessing(
                y_pred, y_true, protected_attrs, threshold=threshold
            )
            ...
            adjusted_proba, calibration_params = fairness_mitigation.calibrated_equalized_odds(
                y_pred, y_true, protected_attrs, cost_constraint=cost_constraint
            )
                    ...
                    "parameters": [
                        {
                            ...
                            "type": "string",
                            "required": True,
                            "description": "Protected attribute column name",
                        },
                        {
                            "name": "outcome_column",
                            "type": "string",
                ...
                },
                {
                    ...
                    "parameters": [
                        ...
                        },
                        {
                            ...
                            "type": "array",
                            "required": True,
                            "description": "List of feature columns to transform",
                        },
                        {
                            "name": "repair_level",
                            "type": "number",
                            "required": False,
                            "description": "Level of repair (0.0 to 1.0, where 1.0 is full repair)",
                        },
                    ],
                },
            ],
                    ...
                    "parameters": [
                        {
                            ...
                            "type": "number",
                            "required": False,
                            "description": "Initial classification threshold",
                        }
                    ],
                },
                {
                    ...
                    "parameters": [
                        {
                            ...
                            "type": "string",
                            "required": False,
                            "description": "Type of cost constraint ('fpr', 'tpr', or 'weighted')",
                        }
                    ],
                },
            ],
