...
class TestFairness(unittest.TestCase):
    ...
    def test_detect_outcome_bias_biased(self):
        ...
        has_age_bias = any(finding['attribute'] == 'age_group' for finding in fairness_report.get('detailed_findings', []))
        has_gender_bias = any(finding['attribute'] == 'gender' for finding in fairness_report.get('detailed_findings', []))
