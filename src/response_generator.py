...
class ResponseGenerator:
    ...
    def __init__(self, 
        ...
        self.cache_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "cache", "responses")
    ...
    def _classify_query(self, query: str) -> str:
        ...
        try:
            ...
            valid_categories = ["investment_advice", "account_inquiry", "loan_inquiry", "complaint", "general"]
    ...
    def _generate_response_text(self, query: str, category: str, context: Dict = None) -> Dict[str, Any]:
        """
