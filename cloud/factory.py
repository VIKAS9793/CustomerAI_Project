...
from cloud.errors import CloudConfigurationError, CloudError, handle_cloud_error
            ...
            if provider is None:
                ...
                try:
                    ...
                    raise CloudConfigurationError(
                        f"Unknown provider: {provider}", service="storage"
                    )
        ...
        try:
            if provider is None:
                ...
                try:
                    ...
                    raise CloudConfigurationError(
                        f"Unknown provider: {provider}", service="database"
                    )
        ...
        try:
            if provider is None:
                ...
                try:
                    ...
                    raise CloudConfigurationError(f"Unknown provider: {provider}", service="ai")
        ...
        try:
            if provider is None:
                ...
                try:
                    ...
                    raise CloudConfigurationError(
                        f"Unknown provider: {provider}", service="security"
                    )
        ...
        try:
            if provider is None:
                ...
                try:
                    ...
                    raise CloudConfigurationError(
                        f"Unknown provider: {provider}", service="serverless"
                    )
        ...
        try:
            if provider is None:
                ...
                try:
                    ...
                    raise CloudConfigurationError(
                        f"Unknown provider: {provider}", service="monitoring"
                    )
