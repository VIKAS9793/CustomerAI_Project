...
from cloud.errors import handle_aws_error, CloudResourceNotFoundError
...
class AWSS3Client(CloudStorageClient):
    ...
    def list_files(self, prefix: str = "", **kwargs) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # Convert to standardized error and log
            cloud_error = handle_aws_error(e, "s3", "list_files")
            # Note: We don't log here since retry decorator will handle it
    ...
    def bulk_upload(self, local_directory: str, remote_prefix: str = "", **kwargs) -> Dict[str, Any]:
        """
    ...
    def bulk_download(self, remote_prefix: str, local_directory: str, **kwargs) -> Dict[str, Any]:
        ...
        for file_info in files:
            ...
            if remote_prefix:
                ...
                rel_path = remote_path[len(remote_prefix):] if remote_path.startswith(remote_prefix) else remote_path
