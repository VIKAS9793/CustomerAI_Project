...
class AWSSageMakerClient(CloudAIClient):
    ...
    def predict(self, data: Any, model_name: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "prediction": result, "model": model_name}
    ...
    def get_model_metrics(self, model_name: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            metrics["invocations"] = {
                "timestamps": [
                    t.timestamp() for t in invocation_metrics["MetricDataResults"][0]["Timestamps"]
                ],
            ...
            metrics["model_latency"] = {
                "timestamps": [
                    t.timestamp() for t in invocation_metrics["MetricDataResults"][1]["Timestamps"]
                ],
    ...
    def get_model_status(self, model_name: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "last_modified_time": (
                    endpoint_desc.get("LastModifiedTime") if endpoint_exists else None
                ),
                "monitoring_schedules": (
                    endpoint_desc.get("MonitoringSchedules", []) if endpoint_exists else []
                ),
            }
    ...
    def create_training_job(
        ...
        **kwargs,
        ...
        try:
            ...
            if validate_data:
                estimator.fit(
                    {"train": train_data, "validation": validate_data},
                    job_name=job_name,
                )
            else:
